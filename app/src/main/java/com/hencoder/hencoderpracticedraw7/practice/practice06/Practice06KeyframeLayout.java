    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PropertyValuesHolder process = PropertyValuesHolder.ofKeyframe("progress", keyframe1, keyframe2, keyframe3);
                ObjectAnimator objectAnimator = ObjectAnimator.ofPropertyValuesHolder(view, process);
